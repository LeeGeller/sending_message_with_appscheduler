# Отправка сообщений с использованием Crontab

Этот проект использует библиотеку **Crontab** для планирования и отправки сообщений в заданное время. Он предоставляет гибкую настройку для выполнения задач в фоновом режиме, таких как отправка сообщений или уведомлений.
...
- **Crontab** — библиотека для планирования задач
