# Generated by Django 4.2.2 on 2024-05-25 19:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clients_list', models.ManyToManyField(blank=True, null=True, to='schedule.client', verbose_name='Клиенты для рассылки')),
                ('mailing_list', models.ManyToManyField(blank=True, null=True, to='schedule.newsletter', verbose_name='Письма для рассылки')),
            ],
            options={
                'verbose_name': 'Лог',
